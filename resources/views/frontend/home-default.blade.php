                                ...
                                <div class="swiper-wrapper row cols-lg-1 cols-md-3">
                                    <div class="swiper-slide product-widget-wrap">
                                        <div class="product product-widget bb-no">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Kitchen Cooker</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                        ...
                                        <div class="product product-widget bb-no">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Professional Pixel Camera</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                                        ...
                                        <div class="product product-widget">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Sport Women’s Wear</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                                    ...
                                    <div class="swiper-slide product-widget-wrap">
                                        <div class="product product-widget bb-no">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Latest Speaker</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                                        ...
                                        <div class="product product-widget bb-no">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Men's Black Wrist Watch</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                        ...
                                        <div class="product product-widget">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Wash Machine</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <div class="swiper-slide product-widget-wrap">
                                        <div class="product product-widget bb-no">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Security Guard</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                        ...
                                        <div class="product product-widget bb-no">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">Apple Super Notecom</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                        ...
                                        <div class="product product-widget">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name">
                                                    <a href="{{ url('/product') }}">HD Television</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                ...
                <div class="swiper-container swiper-theme pg-show" data-swiper-options="{
                    ...
                    <div class="swiper-wrapper row cols-lg-6 cols-md-5 cols-sm-3 cols-2">
                        <div
                            ...
                            <a href="{{ url('/product-list') }}" class="category-media">
                                <img src="{{ asset('frontend/assets/images/demos/demo1/categories/2-1.jpg') }}" alt="Category"
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="{{ url('/product-list') }}" class="category-media">
                                <img src="{{ asset('frontend/assets/images/demos/demo1/categories/2-2.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="{{ url('/product-list') }}" class="category-media">
                                <img src="{{ asset('frontend/assets/images/demos/demo1/categories/2-3.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="{{ url('/product-list') }}" class="category-media">
                                <img src="{{ asset('frontend/assets/images/demos/demo1/categories/2-4.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="{{ url('/product-list') }}" class="category-media">
                                <img src="{{ asset('frontend/assets/images/demos/demo1/categories/2-5.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="{{ url('/product-list') }}" class="category-media">
                                <img src="{{ asset('frontend/assets/images/demos/demo1/categories/2-6.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                ...
                <div class="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Classic Hat</a></h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 60%;"></span>
                                        <span class="tooltiptext tooltip-top"></span>
                                    </div>
                                    <a href="{{ url('/product') }}" class="rating-reviews">(1 Reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Women’s White
                                        Handbag</a></h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 80%;"></span>
                                    ...
                                    <a href="{{ url('/product') }}" class="rating-reviews">(3 reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Multi Funtional Apple
                                        iPhone</a></h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <a href="{{ url('/product') }}" class="rating-reviews">(5 reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Fashion Blue Towel</a>
                                </h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <a href="{{ url('/product') }}" class="rating-reviews">(8 reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Apple Super Notecom</a>
                                </h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <a href="{{ url('/product') }}" class="rating-reviews">(4 reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Women’s Comforter</a>
                                </h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <a href="{{ url('/product') }}" class="rating-reviews">(10 reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Multi-colorful Music</a>
                                </h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 60%;"></span>
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Comfortable Backpack</a>
                                </h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <a href="{{ url('/product') }}" class="rating-reviews">(6 reviews)</a>
                                </div>
                                <div class="product-price">
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Data Transformer Tool
                                    </a></h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 60%;"></span>
                    ...
                    <div class="product-wrap">
                        <div class="product text-center">
                            ...
                            <div class="product-details">
                                <h4 class="product-name"><a href="{{ url('/product') }}">Women’s hairdye</a></h4>
                                <div class="ratings-container">
                                    <div class="ratings-full">
                                        <span class="ratings" style="width: 60%;"></span>
                                        <span class="tooltiptext tooltip-top"></span>
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Men’s
                                                Clothing</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="{{ url('/product') }}" class="rating-reviews">(3
                                                reviews)</a>
                                        </div>
                                        <div class="product-price">
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Best Travel
                                                Bag</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Women’s Fashion
                                                Handbag </a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Gray Leather
                                                Shoes</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Black Winter
                                                Skating</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Men's Black
                                                Wrist
                                                Watch</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Sport Women's
                                                Wear</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Women’s Hiking
                                                Hat</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Professional
                                                Pixel
                                                Camera</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="{{ url('/product') }}" class="rating-reviews">(5
                                                reviews)</a>
                                        </div>
                                        <div class="product-price">
                                            <ins class="new-price">$215.68</ins><del
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Latest
                                                Speaker</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Wash Machine</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                                            ...
                                            <a href="{{ url('/product') }}" class="rating-reviews">(9
                                                reviews)</a>
                                        </div>
                                        <div class="product-price">
                                            <ins class="new-price">$215.68</ins>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Security
                                                Guard</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">HD
                                                Television</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">USB Receipt</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Data Transformer
                                                Tool</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                                            ...
                                            <a href="{{ url('/product') }}" class="rating-reviews">(6
                                                reviews)</a>
                                        </div>
                                        <div class="product-price">
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Multi Functional
                                                Apple iPhone</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Home Sofa</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Electric
                                                Rice-Cooker</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Kitchen
                                                Table</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Table Lamp</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Electric Frying
                                                Pan</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Latest Chair</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                                ...
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{ url('/product') }}">Automatic
                                                Crusher</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
            ...
            <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        <figure class="product-media">
                            <a href="product-defa{{ url('/product') }}">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">Women's Fashion Handbag</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">Electric Frying Pan</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">Black Winter Skating</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
                ...
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">Home Sofa</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">USB Receipt</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">Electric Rice-Cooker</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="{{ url('/product') }}">Table Lamp</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
