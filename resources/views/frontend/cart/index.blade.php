                ...
                <div class="container">
                    <div class="row gutter-lg mb-10">
                        <div class="col-lg-8 pr-lg-4 mb-6">
                            <table class="shop-table" id="all-cart-refresh">
                                <thead>
                                    <tr>
                                        ...
                                        <tr class="cart-item-wrap">
                                            ...
                                            <td class="product-quantity">
                                                <div class="input-group">
                                                    <input onchange="changeQty('{{ $item->rowId }}', this.value)" class="quantity form-control" type="number" min="1" max="100000" value="{{ $item->qty }}">
                            ...
                            <div class="cart-action mb-6 mt-6">
                                ...
                                <button type="submit" class="btn btn-rounded btn-update update-cart" value="Update Cart">Update Cart</button>
                            </div>
                        </div>
                                    ...
                                    <div class="shipping-calculator">
                                        <form class="shipping-calculator-form">
                                            <div class="form-group">
                                                <input class="form-control form-control-md promo_code" type="text"
