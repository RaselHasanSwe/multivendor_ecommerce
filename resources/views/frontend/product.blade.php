                                    ...
                                    <div class="swiper-wrapper row cols-1 gutter-no">
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend/assets/images/products/default/1-800x900.jpg') }}"
                                                    data-zoom-image="{{ asset('frontend/assets/images/products/default/1-800x900.jpg') }}"
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend/assets/images/products/default/2-800x900.jpg') }}"
                                                    data-zoom-image="{{ asset('frontend/assets/images/products/default/2-800x900.jpg') }}"
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend/assets/images/products/default/3-800x900.jpg') }}"
                                                    data-zoom-image="{{ asset('frontend/assets/images/products/default/3-800x900.jpg') }}"
                                                    alt="Electronics Black Wrist Watch" width="800" height="900">
                                            </figure>
                                        </div>
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend/assets/images/products/default/4-800x900.jpg') }}"
                                                    data-zoom-image="{{ asset('frontend/assets/images/products/default/4-800x900.jpg') }}"
                                                    alt="Electronics Black Wrist Watch" width="800" height="900">
                                            </figure>
                                        </div>
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend/assets/images/products/default/5-800x900.jpg') }}"
                                                    data-zoom-image="{{ asset('frontend/assets/images/products/default/5-800x900.jpg') }}"
                                                    alt="Electronics Black Wrist Watch" width="800" height="900">
                                            </figure>
                                        </div>
                                        <div class="swiper-slide">
                                            <figure class="product-image">
                                                <img src="{{ asset('frontend/assets/images/products/default/6-800x900.jpg') }}"
                                                    data-zoom-image="{{ asset('frontend/assets/images/products/default/6-800x900.jpg') }}"
                                                    alt="Electronics Black Wrist Watch" width="800" height="900">
                                            </figure>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 mb-4 mb-md-6">
                            <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                ...
                                <div class="product-bm-wrapper">
                                    <figure class="brand">
                                        <img src="{{ asset('frontend/assets/images/products/brand/brand-1.jpg') }}" alt="Brand"
                                            width="102" height="48" />
                                    </figure>
                    ...
                    <div class="frequently-bought-together mt-5">
                        ...
                        <div class="bought-together-products row mt-8 pb-4">
                            ...
                            <div class="product-button">
                                ...
                                <a href="{{ url('/cart')}}" class="btn btn-dark btn-rounded">Add All To Cart</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-container swiper-theme" data-swiper-options="{
                            ...
                            <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                <div class="swiper-slide product">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('frontend/assets/images/products/default/1-1.jpg') }}" alt="Product"
                                ...
                                <div class="swiper-slide product">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('frontend/assets/images/products/default/2.jpg') }}" alt="Product"
                                                width="300" height="338" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('frontend/assets/images/products/default/3.jpg') }}" alt="Product"
                                                width="300" height="338" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('frontend/assets/images/products/default/4-1.jpg') }}" alt="Product"
                                                width="300" height="338" />
                                            <img src="{{ asset('frontend/assets/images/products/default/4-2.jpg') }}" alt="Product"
                                                width="300" height="338" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
