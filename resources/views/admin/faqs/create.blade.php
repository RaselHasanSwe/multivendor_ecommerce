            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form Detailsform class="form form-horizontal" id="faqForm" method="post" action="{{ route('admin.faqs.save') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn btn-warning mr-1" onclick="resetForm('faqForm')">
