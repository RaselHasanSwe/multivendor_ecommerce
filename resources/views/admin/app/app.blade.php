...
<head>
    ...
    @if ( isset($g_settings->favicon))
        <link rel="apple-touch-icon" href="{{ asset('admin/site_setting/favicon/'.$g_settings->favicon)}}">
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin/site_setting/favicon/'.$g_settings->favicon)}}">
    @else
...
<body class="vertical-layout vertical-menu 2-columns  footer-fixed fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
    ...
    <script src="{{ asset('admin/app-assets/bijoytechJs/sajib.bijoytech.js') }}"></script>
    <script src="{{ asset('admin/app-assets/bijoytechJs/sahadat.bijoytech.js') }}"></script>
    <script src="{{ asset('admin/app-assets/bijoytechJs/sakhawat.bijoytech.js') }}"></script>
    <script src="{{ asset('admin/app-assets/bijoytechJs/farhinaafrin.bijoytech.js') }}"></script>
