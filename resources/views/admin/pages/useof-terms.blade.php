...
@section('pageHeading')
    @include('admin.app.page-heading', ['menu'=>'Term of Use', 'menu_url'=>route('admin.use-of-term'),'page'=>'Term of Use'] )
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Term of Use</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal"  method="post" action="{{ route('admin.use-of-term.save') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="text" value="{{ isset( $userOfTerm->title ) ? $userOfTerm->title : '' }}" id="title" class="form-control" name="title">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <textarea id="summernote" required rows="5" class="form-control " name="description" placeholder="Term of Use">{{ isset( $userOfTerm->description ) ? $userOfTerm->description : '' }}</textarea>
                                    </div>
                                </div>
