...
@section('pageHeading')
    @include('admin.app.page-heading', ['menu'=>'Refund & Return Policy', 'menu_url'=>route('admin.refund-policy'),'page'=>'Refunds & Return Policy'] )
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Refund & Return Policy</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal"  method="post" action="{{ route('admin.refund-policy.save') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
